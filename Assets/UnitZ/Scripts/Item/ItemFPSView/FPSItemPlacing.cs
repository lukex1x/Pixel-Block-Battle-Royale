        ...
        if (preplacingObject != null)
        {
            ...
            if (surface.distance != 0)
            {
                ...
                else
                {
                    ...
                    if (PlacingNormal)
                    {
                        preplacingObject.transform.rotation = Quaternion.LookRotation(character.transform.forward, surface.normal);
                    }
                    else
                    {
                        preplacingObject.transform.rotation = Quaternion.LookRotation(character.transform.forward);
                    }
                }
            }
            else
